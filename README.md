...
[![](https://img.shields.io/badge/JSON-8.13.2025-deeppink.svg?label=zip.min.json)](https://www.rossby.info)
[![](https://img.shields.io/badge/JSON-8.13.2025-deeppink.svg?label=state.min.json)](https://www.rossby.info)
...
> As such, ZTCA data for FIPS `09001` and `51830` are absent from the generated GEOJSON.
